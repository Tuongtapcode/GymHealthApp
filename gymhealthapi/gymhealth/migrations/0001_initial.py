    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Mô tả chi tiết')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Điểm đánh giá')),
                ('comment', ckeditor.fields.RichTextField(blank=True, null=True, verbose_name='Nhận xét')),
                ('anonymous', models.BooleanField(default=False, verbose_name='Ẩn danh')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('facility_score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Cơ sở vật chất')),
                ('service_score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Chất lượng dịch vụ')),
                ('gym', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='gymhealth.gym')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_given', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('health_conditions', ckeditor.fields.RichTextField(help_text='Các vấn đề sức khỏe đặc biệt')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('notes', ckeditor.fields.RichTextField(blank=True, help_text='Ghi chú về tình trạng sức khỏe', null=True)),
                ...
                ('medical_conditions', ckeditor.fields.RichTextField(blank=True, help_text='Các vấn đề sức khỏe cần lưu ý', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('description', ckeditor.fields.RichTextField(verbose_name='Mô tả gói tập')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_given', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('response_text', ckeditor.fields.RichTextField(verbose_name='Nội dung phản hồi')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('gym_rating', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='gymhealth.gymrating')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', ckeditor.fields.RichTextField(blank=True, null=True)),
                ('trainer_notes', ckeditor.fields.RichTextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cardio_endurance', models.IntegerField(blank=True, help_text='Thời gian chịu đựng cardio (phút)', null=True)),
                ('strength_bench', models.FloatField(blank=True, help_text='1RM Bench Press (kg)', null=True)),
                ('strength_squat', models.FloatField(blank=True, help_text='1RM Squat (kg)', null=True)),
                ('strength_deadlift', models.FloatField(blank=True, help_text='1RM Deadlift (kg)', null=True)),
                ('notes', ckeditor.fields.RichTextField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('workout_session', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='progress_record', to='gymhealth.workoutsession')),
            ],
            options={
